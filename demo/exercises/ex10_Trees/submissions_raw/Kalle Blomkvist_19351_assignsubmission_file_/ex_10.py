...
class Tree(object):
    ...
    def is_xbar(self):
        ...
        :rtype bool"""
        return (self.is_phrase_projection() or self.is_bar_projection() or
                self.is_head_projection() or self.is_terminal())
    ...
    def is_adjunct_structure(self):
        ...
        :rtype bool"""
        return self.is_binary() and (
                (self.children[0].is_phrase_projection() and self.children[1].is_bar_projection()) or
                (self.children[1].is_phrase_projection() and self.children[0].is_bar_projection()))
