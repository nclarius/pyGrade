...
class Tree(object):
    ...
    def postorder(self):
        ...
        result = []
        for i in range(len(self.children)):
            result += self.children[i].postorder()
        result.append(self)
        return result
    ...
    def is_xbar(self):
        ...
        :rtype bool"""
        return (self.is_bar_projection() or self.is_phrase_projection() or
                self.is_terminal() or self.is_head_projection())
