...
class Tree(object):
    ...
    def is_xbar(self):
        ...
        return self.is_terminal() or self.is_phrase_projection() or self.is_bar_projection() or self.is_head_projection()
    ...
    def is_bar_projection(self):
        ...
        return self.level ==1 and self.same_cat_as_parent() and self.is_no_adjunct_or_complement_structure() or \
               self.is_adjunct_structure() or self.is_complement_structure()
                #second X'
    ...
    def is_head_projection(self):
        ...
        :rtype bool"""
        return self.level == 0 and self.same_cat_as_parent() and self.is_unary() and self.children[0].is_terminal()

    # ----------------------
    # Check structural constraints for the respective projection levels
    # ----------------------

    def is_no_specifier_structure(self):
    ...
    def is_specifier_structure(self):
        ...
        :rtype bool"""
        return self.is_binary() and self.children[0].is_no_specifier_structure() and self.children[1].is_bar_projection()

    def is_no_adjunct_or_complement_structure(self):
        ...
        :rtype bool""" # TODO
        return  self.is_unary() and self.children[0].is_head_projection()

    def is_complement_structure(self):
    ...
    def is_adjunct_structure(self):
        ...
        :rtype bool"""# TODO
        return self.is_binary() and (self.children[0].is_phrase_projection() and self.children[1].is_bar_projection()) or \
        self.is_binary() and (self.children[1].is_phrase_projection() and self.children[0].is_bar_projection())
