...
class Tree(object):
    ...
    def postorder(self):
        ...
        First recurse through the node's children, then visit the node itself.
    ...
    def is_xbar(self):
        ...
        :rtype bool"""
        return self.is_phrase_projection() or self.is_bar_projection() or self.is_head_projection() or \
            self.is_terminal()
    ...
    def is_head_projection(self):
        ...
        :rtype bool"""
        return (self.level == 0 and self.same_cat_as_parent() and
                self.is_head_structure())
    ...
    def is_specifier_structure(self):
        ...
        return (self.is_binary() and
                # specifier YP on left, X' on right
                self.children[0].is_phrase_projection() and self.children[1].is_bar_projection())
