...
from sex_09 import *
import solution_ex_09

tasks = {1: ("Traversals", 2.0),
         2: ("X-bar check", 6.0)}
total_points = 8.0
...
class TestTask1(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.abc_preorder = ['A', 'B', 'D', 'C', 'E', 'F', 'G', 'H']
        self.abc_postorder = ['D', 'B', 'E', 'F', 'H', 'G', 'C', 'A']
    ...
    def test_01_preorder_1(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.book.preorder())[:4], self.book_preorder[:4])

    def test_01_preorder_2(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.abc.preorder())[:4], self.abc_preorder[:4])

    def test_01_preorder_3(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.book.preorder()), self.book_preorder)

    def test_01_preorder_4(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.abc.preorder()), self.abc_preorder)

    #  Postorder

    def test_02_postorder_1(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.book.postorder())[:4], self.book_postorder[:4])

    def test_02_postorder_2(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.abc.postorder())[:4], self.abc_postorder[:4])

    def test_02_postorder_3(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.book.postorder()), self.book_postorder)

    def test_02_postorder_4(self):
        """:points: 0.25"""
        self.assertEqual(Tree.names(self.abc.postorder()), self.abc_postorder)


class TestTask2(unittest.TestCase):
    """":points: 6.0"""
    # is_xbar:              1.5
    # projection functions: 2.0 (1.0 each)
    # structure functions:  2.5 (0.5 each)
    ...
    def test_01_is_xbar_1(self):
        ...
        self.assertTrue(self.on_the_mats.is_xbar())
        self.assertTrue(self.small_black_cat.is_xbar())

    def test_01_is_xbar_2(self):
        """:points: 0.75"""
        self.assertFalse(self.cat_ill_no_N1.is_xbar())
        self.assertFalse(self.cat_ill_two_N1.is_xbar())
        self.assertFalse(self.cat_ill_Dbar_category_mismatch_recursion.is_xbar())
        self.assertFalse(self.cat_ill_Dhead_category_mismatch_recursion.is_xbar())
        self.assertFalse(self.mat_ill_no_head.is_xbar())
        self.assertFalse(self.mat_ill_two_heads.is_xbar())
    ...
    #     self.assertFalse(self.cat_ill_nonense_phrase.is_xbar())
    #
    # def test_02_is_phrase_projection_5(self):
    #     self.assertFalse(self.cat_ill_no_N1.is_phrase_projection())
    #     self.assertFalse(self.cat_ill_two_N1.is_phrase_projection())
    #
    # def test_02_is_phrase_projection_6(self):
    #     self.assertFalse(self.cat_ill_no_N1.is_phrase_projection())
    ...
    def test_03_is_bar_projection_2(self):
        """:points: 0.2"""
    ...
    def test_03_is_bar_projection_5(self):
        """:points: 0.2"""
        self.assertFalse(self.cat_ill_Dbar_category_mismatch_recursion.is_xbar())
        self.assertFalse(self.mat_ill_no_head_recursion.is_xbar())
        self.assertFalse(self.mat_ill_two_heads_recursion.is_xbar())
    ...
    def test_05_is_no_specifier_structure_3(self):
        """:points: 0.125"""
        self.assertFalse(self.cat_N.is_no_specifier_structure())

    def test_05_is_no_specifier_structure_4(self):
        """:points: 0.125"""
    ...
    def test_06_is_specifier_structure_3(self):
        """:points: 0.125"""
        self.assertFalse(self.on_the_mat_Pbar.is_specifier_structure())

    def test_06_is_specifier_structure_4(self):
        """:points: 0.125"""
    ...
    def test_07_is_no_adjunct_or_complement_structure_3(self):
        """:points: 0.125"""
        self.assertFalse(self.cat_NP.is_no_adjunct_or_complement_structure())

    def test_07_is_no_adjunct_or_complement_structure_4(self):
        """:points: 0.125"""
    ...
    #     self.assertTrue(self.on_the_mat_Pbar.is_complement_structure())
    #
    # def test_08_is_complement_structure_2(self):
    #     self.assertFalse(self.cat_on_the_mat.is_complement_structure())
    #
    # def test_08_is_complement_structure_3(self):
    #     self.assertFalse(self.on_the_mat.is_complement_structure())
    ...
    def test_09_is_adjunct_structure_2(self):
        """:points: 0.125"""
        self.assertTrue(self.small_cat.is_adjunct_structure())
        self.assertTrue(self.small_black_cat.is_adjunct_structure())

    def test_09_is_adjunct_structure_3(self):
        """:points: 0.125"""
        self.assertFalse(self.on_the_mat_Pbar.is_adjunct_structure())
        self.assertFalse(self.cat_Nbar.is_adjunct_structure())

    def test_09_is_adjunct_structure_4(self):
        """:points: 0.125"""
    ...
    def test_10_is_head_structure_2(self):
        """:points: 0.125"""
        self.assertFalse(self.cat_NP.is_head_structure())

    def test_10_is_head_structure_3(self):
        """:points: 0.125"""
        self.assertFalse(self.cat_terminal.is_head_structure())

    def test_10_is_head_structure_4(self):
        """:points: 0.125"""
