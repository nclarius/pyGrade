...
class Tree(object):
    ...
    def is_bar_projection(self):
        ...
        :rtype bool"""
        return ((self.level == 1 and self.same_cat_as_parent()) and
                (self.is_no_adjunct_or_complement_structure() or self.is_complement_structure() or
    ...
    def is_specifier_structure(self):
        ...
        :rtype bool"""
        return self.is_binary() and self.children[0].is_phrase_projection() and self.children[1].is_bar_projection()
    ...
    def is_adjunct_structure(self):
        ...
        :rtype bool"""
        return self.is_binary() and (self.children[0].is_phrase_projection() or self.children[0].is_bar_projection()) \
            and (self.children[1].is_phrase_projection() or self.children[1].is_bar_projection())
