...
class Tree(object):
    ...
    def is_xbar(self):
        ...
        :rtype bool"""
        return self.is_phrase_projection() or self.is_bar_projection() or self.is_head_projection() or self.is_terminal()
    ...
    def is_bar_projection(self):
        ...
        :rtype bool"""
        return (self.level == 1 and self.same_cat_as_parent() and (self.is_no_adjunct_or_complement_structure() or self.is_complement_structure() or self.is_adjunct_structure()))
    ...
    def is_specifier_structure(self):
        ...
        :rtype bool"""
        return not self.is_no_specifier_structure()
    ...
    def is_no_adjunct_or_complement_structure(self):
        ...
        :return true if self is a X' with no adjunct or complement
        :rtype bool"""
    ...
    def is_adjunct_structure(self):
        ...
        :rtype bool"""
        return self.is_binary() and ((self.children[0].is_phrase_projection() and self.children[1].is_bar_projection()) or (self.children[0].is_bar_projection() and self.children[1].is_phrase_projection()))
